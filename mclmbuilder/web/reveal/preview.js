...
!function (t, e, i) {
    ...
    function o(t) {
        var e = T.className, i = S._config.classPrefix || "", n = new RegExp("(^|\\s)" + i + "no-js(\\s|$)");
    ...
    function m(t, e, i, s, o) {
        var a = t.charAt(0).toUpperCase() + t.slice(1), r = (t + " " + C.join(a + " ") + a).split(" ");
    ...
    y._prefixes = E;
    var T = e.documentElement, L = "Webkit Moz O ms", _ = y._config.usePrefixes ? L.toLowerCase().split(" ") : [];
    y._domPrefixes = _;
    var w = function () {
    ...
    var k = y.testStyles = r, C = y._config.usePrefixes ? L.split(" ") : [];
    y._cssomPrefixes = C;
    ...
    y.testAllProps = m, y.testAllProps = g, S.addTest("backgroundsize", g("backgroundSize", "100%", !0)), S.addTest("cssanimations", g("animationName", "a", !0)), S.addTest("csstransforms", g("transform", "scale(1)", !0)), S.addTest("csstransforms3d", function () {
        var t = !!g("perspective", "1px", !0), e = S._config.usePrefixes;
    ...
    function d(t, e, i, n) {
        if (se.acceptData(t)) {
            ...
            if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e)return c || (c = r ? t[a] = Y.pop() || se.guid++ : a), l[c] || (l[c] = r ? {} : {toJSON: se.noop}), ("object" == typeof e || "function" == typeof e) && (n ? l[c] = se.extend(l[c], e) : l[c].data = se.extend(l[c].data, e)), o = l[c], n || (o.data || (o.data = {}), o = o.data), void 0 !== i && (o[se.camelCase(e)] = i), "string" == typeof e ? (s = o[e], null == s && (s = o[se.camelCase(e)])) : s = o, s
        }
    }
    ...
    function N(t, e, i) {
        for (var n, s = (yi[e] || []).concat(yi["*"]), o = 0, a = s.length; a > o; o++)if (n = s[o].call(i, e, t))return n
    }
    ...
    function $(t, e, i) {
        ...
        for (U(d, c.opts.specialEasing); a > o; o++)if (n = bi[o].call(c, t, d, c.opts))return n;
    ...
    function F(t) {
        return function (e, i) {
            ...
            var n, s = 0, o = e.toLowerCase().match(ye) || [];
    ...
    var Y = [], J = Y.slice, q = Y.concat, K = Y.push, Q = Y.indexOf, Z = {}, te = Z.toString, ee = Z.hasOwnProperty, ie = {}, ne = "1.11.1", se = function (t, e) {
    ...
    var ce = function (t) {
        ...
        function v(t, e, i, s, o, a) {
            return s && !s[F] && (s = v(s)), o && !o[F] && (o = v(o, a)), n(function (n, a, r, l) {
                var c, d, h, u = [], p = [], f = a.length, v = n || m(e || "*", r.nodeType ? [r] : r, []), b = !t || !n && e ? v : g(v, u, t, r, l), y = i ? o || (n ? t : f || s) ? [] : a : b;
                if (i && i(b, y, r, l), s)for (c = g(y, p), s(c, [], r, l), d = c.length; d--;)(h = c[d]) && (y[p[d]] = !(b[p[d]] = h));
                if (n) {
                    if (o || t) {
                        if (o) {
        ...
        function y(t, i) {
            var s = i.length > 0, o = t.length > 0, a = function (n, a, r, l, c) {
                var d, h, u, p = 0, f = "0", m = n && [], v = [], b = A, y = n || o && T.find.TAG("*", c), S = B += null == b ? 1 : Math.random() || .1, E = y.length;
        ...
        var S, E, T, L, _, w, k, C, A, x, D, I, M, R, O, N, P, U, $, F = "sizzle" + -new Date, j = t.document, B = 0, H = 0, z = i(), V = i(), G = i(), W = function (t, e) {
            return t === e && (D = !0), 0
        }, X = "undefined", Y = 1 << 31, J = {}.hasOwnProperty, q = [], K = q.pop, Q = q.push, Z = q.push, te = q.slice, ee = q.indexOf || function (t) {
        ...
        }, me = /^(?:input|select|textarea|button)$/i, ge = /^h\d$/i, ve = /^[^{]+\{\s*\[native \w/, be = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, Se = /'|\\/g, Ee = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), Te = function (t, e, i) {
            var n = "0x" + e - 65536;
                    ...
                    return 1 === n && 0 === s ? function (t) {
                        ...
                        if (g) {
                            ...
                            if (f = [a ? g.firstChild : g.lastChild], a && b) {
                                for (d = g[F] || (g[F] = {}), c = d[t] || [], p = c[0] === B && c[1], u = c[0] === B && c[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (u = p = 0) || f.pop();)if (1 === h.nodeType && ++u && h === e) {
                                    d[t] = [B, p, u];
                                    break
                                }
                            } else if (b && (c = (e[F] || (e[F] = {}))[t]) && c[0] === B)u = c[1]; else for (; (h = ++p && h && h[m] || (u = p = 0) || f.pop()) && ((r ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++u || (b && ((h[F] || (h[F] = {}))[t] = [B, u]), h !== e)););
        ...
        for (S in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0})T.pseudos[S] = r(S);
        for (S in{submit: !0, reset: !0})T.pseudos[S] = l(S);
        return h.prototype = T.filters = T.pseudos, T.setFilters = new h, w = e.tokenize = function (t, i) {
            ...
            if (i = i || [], 1 === h.length) {
                ...
                for (s = fe.needsContext.test(t) ? 0 : o.length; s-- && (a = o[s], !T.relative[r = a.type]);)if ((l = T.find[r]) && (n = l(a.matches[0].replace(Ee, Te), ye.test(o[0].type) && d(e.parentNode) || e))) {
    ...
    se.fn.ready = function (t) {
        ...
        if (!Ee)if (Ee = se.Deferred(), "complete" === fe.readyState)setTimeout(se.ready); else if (fe.addEventListener)fe.addEventListener("DOMContentLoaded", r, !1), t.addEventListener("load", r, !1); else {
    ...
    var ke = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ce = ["Top", "Right", "Bottom", "Left"], Ae = function (t, e) {
    ...
    se.event = {
        ...
        remove: function (t, e, i, n, s) {
            ...
            if (g && (d = g.events)) {
                for (e = (e || "").match(ye) || [""], c = e.length; c--;)if (r = Ne.exec(e[c]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
    ...
    var Pe = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", Ue = / jQuery\d+="(?:null|\d+)"/g, $e = new RegExp("<(?:" + Pe + ")[\\s/>]", "i"), Fe = /^\s+/, je = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Be = /<([\w:]+)/, He = /<tbody/i, ze = /<|&#?\w+;/, Ve = /<(?:script|style|link)/i, Ge = /checked\s*(?:[^=]|=\s*.checked.)/i, We = /^$|\/(?:java|ecma)script/i, Xe = /^true\/(.*)/, Ye = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Je = {
    ...
    }, qe = m(fe), Ke = qe.appendChild(fe.createElement("div"));
    Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, se.extend({
        clone: function (t, e, i) {
            ...
            if (ie.html5Clone || se.isXMLDoc(t) || !$e.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Ke.innerHTML = t.outerHTML, Ke.removeChild(o = Ke.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || se.isXMLDoc(t)))for (n = g(o), r = g(t), a = 0; null != (s = r[a]); ++a)n[a] && L(s, n[a]);
            ...
            for (var s, o, a, r, l, c, d, h = t.length, u = m(e), p = [], f = 0; h > f; f++)if (o = t[f], o || 0 === o)if ("object" === se.type(o))se.merge(p, o.nodeType ? [o] : o); else if (ze.test(o)) {
                for (r = r || u.appendChild(e.createElement("div")), l = (Be.exec(o) || ["", ""])[1].toLowerCase(), d = Je[l] || Je._default, r.innerHTML = d[1] + o.replace(je, "<$1></$2>") + d[2], s = d[0]; s--;)r = r.lastChild;
                if (!ie.leadingWhitespace && Fe.test(o) && p.push(e.createTextNode(Fe.exec(o)[0])), !ie.tbody)for (o = "table" !== l || He.test(o) ? "<table>" !== d[1] || He.test(o) ? 0 : r : r.firstChild, s = o && o.childNodes.length; s--;)se.nodeName(c = o.childNodes[s], "tbody") && !c.childNodes.length && o.removeChild(c);
                for (se.merge(p, r.childNodes), r.textContent = ""; r.firstChild;)r.removeChild(r.firstChild);
                r = u.lastChild
            } else p.push(e.createTextNode(o));
            for (r && u.removeChild(r), ie.appendChecked || se.grep(g(p, "input"), v), f = 0; o = p[f++];)if ((!n || -1 === se.inArray(o, n)) && (a = se.contains(o.ownerDocument, o), r = g(u.appendChild(o), "script"), a && E(r), i))for (s = 0; o = r[s++];)We.test(o.type || "") && i.push(o);
            return r = null, u
            ...
            for (var i, n, s, o, a = 0, r = se.expando, l = se.cache, c = ie.deleteExpando, d = se.event.special; null != (i = t[a]); a++)if ((e || se.acceptData(i)) && (s = i[r], o = s && l[s])) {
                ...
                l[s] && (delete l[s], c ? delete i[r] : typeof i.removeAttribute !== Le ? i.removeAttribute(r) : i[r] = null, Y.push(s))
            }
        }
    }), se.fn.extend({
        text: function (t) {
            ...
            return xe(this, function (t) {
                ...
                if (!("string" != typeof t || Ve.test(t) || !ie.htmlSerialize && $e.test(t) || !ie.leadingWhitespace && Fe.test(t) || Je[(Be.exec(t) || ["", ""])[1].toLowerCase()])) {
                    t = t.replace(je, "<$1></$2>");
                    try {
            ...
            if (c && (r = se.buildFragment(t, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                ...
                if (s)for (a = o[o.length - 1].ownerDocument, se.map(o, S), l = 0; s > l; l++)n = o[l], We.test(n.type || "") && !se._data(n, "globalEval") && se.contains(a, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Ye, "")));
                r = i = null
            }
            return this
        }
    ...
    var ti, ei, ii = /^margin/, ni = new RegExp("^(" + ke + ")(?!px)[a-z%]+$", "i"), si = /^(top|right|bottom|left)$/;
    ...
    var oi = /alpha\([^)]*\)/i, ai = /opacity\s*=\s*([^)]*)/, ri = /^(none|table(?!-c[ea]).+)/, li = new RegExp("^(" + ke + ")(.*)$", "i"), ci = new RegExp("^([+-])=(" + ke + ")", "i"), di = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    var pi, fi, mi = /^(?:toggle|show|hide)$/, gi = new RegExp("^(?:([+-])=|)(" + ke + ")([a-z%]*)$", "i"), vi = /queueHooks$/, bi = [P], yi = {
        "*": [function (t, e) {
    ...
    var Ei, Ti, Li = se.expr.attrHandle, _i = /^(?:checked|selected)$/i, wi = ie.getSetAttribute, ki = ie.input;
    se.fn.extend({
        attr: function (t, e) {
        ...
        attr: function (t, e, i) {
            ...
            var i, n, s = 0, o = e && e.match(ye);
            if (o && 1 === t.nodeType)for (; i = o[s++];)n = se.propFix[i] || i, se.expr.match.bool.test(i) ? ki && wi || !_i.test(i) ? t[n] = !1 : t[se.camelCase("default-" + i)] = t[n] = !1 : se.attr(t, i, ""), t.removeAttribute(wi ? i : n)
        }, attrHooks: {
            type: {
                set: function (t, e) {
    ...
    var Ci = /^(?:input|select|textarea|button|object)$/i, Ai = /^(?:a|area)$/i;
    se.fn.extend({
        prop: function (t, e) {
    ...
    se.fn.extend({
        addClass: function (t) {
            ...
            if (c)for (e = (t || "").match(ye) || []; l > r; r++)if (i = this[r], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(xi, " ") : " ")) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(se.isFunction(t) ? function (i) {
                ...
                if ("string" === i)for (var e, n = 0, s = se(this), o = t.match(ye) || []; e = o[n++];)s.hasClass(e) ? s.removeClass(e) : s.addClass(e); else(i === Le || "boolean" === i) && (this.className && se._data(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : se._data(this, "__className__") || "")
            })
        }, hasClass: function (t) {
    ...
    var Ri, Oi, Ni = /#.*$/, Pi = /([?&])_=[^&]*/, Ui = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, $i = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Fi = /^(?:GET|HEAD)$/, ji = /^\/\//, Bi = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Hi = {}, zi = {}, Vi = "*/".concat("*");
    try {
        Oi = location.href
    } catch (Gi) {
    ...
    Ri = Bi.exec(Oi.toLowerCase()) || [], se.extend({
        ...
        ajax: function (t, e) {
            ...
            var n, s, o, a, r, l, c, d, h = se.ajaxSetup({}, e), u = h.context || h, p = h.context && (u.nodeType || u.jquery) ? se(u) : se.event, f = se.Deferred(), m = se.Callbacks("once memory"), g = h.statusCode || {}, v = {}, b = {}, y = 0, S = "canceled", E = {
                readyState: 0,
                getResponseHeader: function (t) {
                    var e;
                    if (2 === y) {
                        if (!d)for (d = {}; e = Ui.exec(a);)d[e[1].toLowerCase()] = e[2];
                        e = d[t.toLowerCase()]
                    }
                ...
                statusCode: function (t) {
                    var e;
                    if (t)if (2 > y)for (e in t)g[e] = [g[e], t[e]]; else E.always(t[E.status]);
                    return this
                },
                abort: function (t) {
                    var e = t || S;
            ...
            S = "abort";
            for (s in{success: 1, error: 1, complete: 1})E[s](h[s]);
            if (c = j(zi, h, e, E)) {
    ...
    var Wi = /%20/g, Xi = /\[\]$/, Yi = /\r?\n/g, Ji = /^(?:submit|button|image|reset|file)$/i, qi = /^(?:input|select|textarea|keygen)/i;
    se.param = function (t, e) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !se(this).is(":disabled") && qi.test(this.nodeName) && !Ji.test(t) && (this.checked || !De.test(t))
            }).map(function (t, e) {
                var i = se(this).val();
    ...
    var Ki = 0, Qi = {}, Zi = se.ajaxSettings.xhr();
    ...
    var t, e, i, n, s, o, a, r, l, c, d, h, u, p, f, m, g, v, b, y = [].slice, S = [].indexOf || function (t) {
    ...
    !function (t, e, i, n) {
        ...
        var L, _, w = "virtualMouseBindings", k = "virtualTouchID", C = "vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "), A = "clientX clientY pageX pageY screenX screenY".split(" "), x = t.event.mouseHooks ? t.event.mouseHooks.props : [], D = t.event.props.concat(x), I = {}, M = 0, R = 0, O = 0, N = !1, P = [], U = !1, $ = !1, F = "addEventListener" in i, j = t(i), B = 1, H = 0;
        for (t.vmouse = {
        ...
        F && i.addEventListener("click", function (e) {
            ...
            if (l)for (i = e.clientX, n = e.clientY, L = t.vmouse.clickDistanceThreshold, s = c; s;) {
                for (o = 0; l > o; o++)if (a = P[o], r = 0, s === c && Math.abs(a.x - i) < L && Math.abs(a.y - n) < L || t.data(s, k) === a.touchID)return e.preventDefault(), void e.stopPropagation();
                s = s.parentNode
            }
        }, !0)
    }(t, e, i)
    ...
    var u, p, f = t.documentElement, m = [], g = [], v = {}, b = {}, y = t.createElement("script").async === !0 || "MozAppearance" in t.documentElement.style || window.opera, S = window.head_conf && head_conf.head || "head", E = window[S] = window[S] || function () {
...
JSON || (JSON = {}), function () {
    ...
    function I(t, e, i) {
        var n = j(Math.abs(t) / 1e3), s = j(n / 60), o = j(s / 60), a = j(o / 24), r = j(a / 365), l = 45 > n && ["s", n] || 1 === s && ["m"] || 45 > s && ["mm", s] || 1 === o && ["h"] || 22 > o && ["hh", o] || 1 === a && ["d"] || 25 >= a && ["dd", a] || 45 >= a && ["M"] || 345 > a && ["MM", j(a / 30)] || 1 === r && ["y"] || ["yy", r];
    ...
    for (var U, $, F = "2.2.1", j = Math.round, B = {}, H = "undefined" != typeof module && module.exports, z = /^\/?Date\((\-?\d+)/i, V = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/, G = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g, W = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, X = /\d\d?/, Y = /\d{1,3}/, J = /\d{3}/, q = /\d{1,4}/, K = /[+\-]?\d{1,6}/, Q = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, Z = /Z|[\+\-]\d\d:?\d\d/i, te = /T/i, ee = /[\+\-]?\d+(\.\d{1,3})?/, ie = /^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/, ne = "YYYY-MM-DDTHH:mm:ssZ", se = [["HH:mm:ss.S", /(T| )\d\d:\d\d:\d\d\.\d{1,3}/], ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/], ["HH:mm", /(T| )\d\d:\d\d/], ["HH", /(T| )\d\d/]], oe = /([\+\-]|\d\d)/gi, ae = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"), re = {
        Milliseconds: 1,
        Seconds: 1e3,
        Minutes: 6e4,
        Hours: 36e5,
    ...
    for (ue.DDDD = e(ue.DDD, 3), a(n.prototype, {
        ...
        monthsParse: function (t) {
            var e, i, n;
            for (this._monthsParse || (this._monthsParse = []), e = 0; 12 > e; e++)if (this._monthsParse[e] || (i = U.utc([2e3, e]), n = "^" + this.months(i, "") + "|^" + this.monthsShort(i, ""), this._monthsParse[e] = new RegExp(n.replace(".", ""), "i")), this._monthsParse[e].test(t))return e
        },
        ...
        weekdaysParse: function (t) {
            var e, i, n;
            for (this._weekdaysParse || (this._weekdaysParse = []), e = 0; 7 > e; e++)if (this._weekdaysParse[e] || (i = U([2e3, 1]).day(e), n = "^" + this.weekdays(i, "") + "|^" + this.weekdaysShort(i, "") + "|^" + this.weekdaysMin(i, ""), this._weekdaysParse[e] = new RegExp(n.replace(".", ""), "i")), this._weekdaysParse[e].test(t))return e
        },
        _longDateFormat: {
            LT: "h:mm A",
            L: "MM/DD/YYYY",
        ...
        var i, n, s = U.isDuration(t), a = "number" == typeof t, r = s ? t._input : a ? {} : t, l = V.exec(t);
    ...
    }, U.version = F, U.defaultFormat = ne, U.updateOffset = function () {
    }, U.lang = function (t, e) {
        ...
        clone: function () {
            ...
            var t, e = this._a, i = (this._isUTC ? U.utc(this._a) : U(this._a)).toArray();
            ...
            var n, s, o = this._isUTC ? U(t).zone(this._offset || 0) : U(t).local(), a = 6e4 * (this.zone() - o.zone());
            ...
            var t = this.diff(U().zone(this.zone()).startOf("day"), "days", !0), e = -6 > t ? "sameElse" : -1 > t ? "lastWeek" : 0 > t ? "lastDay" : 1 > t ? "sameDay" : 2 > t ? "nextDay" : 7 > t ? "nextWeek" : "sameElse";
    ...
    function v(t, e, i, s) {
        ...
        for (var l = 0; l < e.length; ++l) {
            var c = l + 1 === e.length, h = c ? r : a(s || y(e[l + 1]).action);
            S(e[l], h, s, t, l)
        }
    }
    ...
    function S(t, e, i, n, s) {
        ...
        var o, r = t.split(" ");
        return r.length > 1 ? void v(t, r, e, i) : (o = y(t, i), A[o.key] = A[o.key] || [], a(o.key, o.modifiers, {type: o.action}, n, t, s), void A[o.key][n ? "unshift" : "push"]({
            callback: e,
    ...
    function k(t, e, i) {
        var n = i.pointers.length, s = i.changedPointers.length, o = e & _e && n - s === 0, a = e & (ke | Ce) && n - s === 0;
    ...
    function z(t, e) {
        ...
        var s, o, a = y(t.changedTouches), r = [], l = this.target;
    ...
    var le = ["", "webkit", "moz", "MS", "ms", "o"], ce = e.createElement("div"), de = "function", he = Math.round, ue = Math.abs, pe = Date.now, fe = 1, me = /mobile|tablet|ip(ad|hone|od)|android/i, ge = "ontouchstart" in t, ve = E(t, "PointerEvent") !== n, be = ge && me.test(navigator.userAgent), ye = "touch", Se = "pen", Ee = "mouse", Te = "kinect", Le = 25, _e = 1, we = 2, ke = 4, Ce = 8, Ae = 1, xe = 2, De = 4, Ie = 8, Me = 16, Re = xe | De, Oe = Ie | Me, Ne = Re | Oe, Pe = ["x", "y"], Ue = ["clientX", "clientY"];
    _.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var $e = {mousedown: _e, mousemove: we, mouseup: ke}, Fe = "mousedown", je = "mousemove mouseup";
    c($, _, {
        handler: function (t) {
            var e = $e[t.type];
    ...
    var Be = {pointerdown: _e, pointermove: we, pointerup: ke, pointercancel: Ce, pointerout: Ce}, He = {
        2: ye,
        3: Se,
        4: Ee,
        5: Te
    ...
    t.MSPointerEvent && (ze = "MSPointerDown", Ve = "MSPointerMove MSPointerUp MSPointerCancel"), c(F, _, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), s = Be[n], o = He[t.pointerType] || t.pointerType, a = o == ye, r = b(e, t.pointerId, "pointerId");
    ...
    var Ge = {
        ...
        touchend: ke,
        touchcancel: Ce
    }, We = "touchstart", Xe = "touchstart touchmove touchend touchcancel";
    c(j, _, {
        handler: function (t) {
            var e = Ge[t.type];
    ...
    c(H, _, {
        handler: function (t) {
            var e = Ye[t.type], i = z.call(this, t, e);
        ...
        handler: function (t, e, i) {
            var n = i.pointerType == ye, s = i.pointerType == Ee;
    ...
    var qe = E(ce.style, "touchAction"), Ke = qe !== n, Qe = "compute", Ze = "auto", ti = "manipulation", ei = "none", ii = "pan-x", ni = "pan-y";
    G.prototype = {
        set: function (t) {
    ...
    X.prototype = {
        ...
        defaults: {event: "press", pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & (ke | Ce) && !o)this.reset(); else if (t.eventType & _e)this.reset(), this._timer = s(function () {
                this.state = li, this.tryEmit()
            }, e.time, this); else if (t.eventType & ke)return li;
            return di
        }, reset: function () {
...
!function (t) {
    ...
    function i(t, e, i) {
        ...
        var n, s, o = F(t, e, i), a = $(t, e, i), r = (o + a) / 2;
        if (o == a)n = s = 0; else {
            var l = o - a;
    ...
    function s(t, e, i) {
        t = L(t, 255), e = L(e, 255), i = L(i, 255);
        var n, s, o = F(t, e, i), a = $(t, e, i), r = o, l = o - a;
    ...
    function g(t) {
        var e = B(t).toHsl(), i = e.h;
        return [B(t), B({h: (i + 120) % 360, s: e.s, l: e.l}), B({h: (i + 240) % 360, s: e.s, l: e.l})]
    }

    function v(t) {
        var e = B(t).toHsl(), i = e.h;
        return [B(t), B({h: (i + 90) % 360, s: e.s, l: e.l}), B({
            h: (i + 180) % 360,
            s: e.s,
            l: e.l
        }), B({h: (i + 270) % 360, s: e.s, l: e.l})]
    }

    function b(t) {
        var e = B(t).toHsl(), i = e.h;
        return [B(t), B({h: (i + 72) % 360, s: e.s, l: e.l}), B({h: (i + 216) % 360, s: e.s, l: e.l})]
    }

    function y(t, e, i) {
        e = e || 6, i = i || 30;
        var n = B(t).toHsl(), s = 360 / i, o = [B(t)];
    ...
    var R = /^[\s,#]+/, O = /\s+$/, N = 0, P = Math, U = P.round, $ = P.min, F = P.max, j = P.random, B = function G(e, i) {
    ...
    B.prototype = {
        isDark: function () {
            ...
            var t = s(this._r, this._g, this._b), e = U(360 * t.h), i = U(100 * t.s), n = U(100 * t.v);
            return 1 == this._a ? "hsv(" + e + ", " + i + "%, " + n + "%)" : "hsva(" + e + ", " + i + "%, " + n + "%, " + this._roundA + ")"
        }, toHsl: function () {
            var t = i(this._r, this._g, this._b);
            return {h: 360 * t.h, s: t.s, l: t.l, a: this._a}
        }, toHslString: function () {
            var t = i(this._r, this._g, this._b), e = U(360 * t.h), n = U(100 * t.s), s = U(100 * t.l);
        ...
        return B.fromRatio({r: j(), g: j(), b: j()})
    }, B.mix = function (t, e, i) {
        i = 0 === i ? 0 : i || 50;
        var n, s = B(t).toRgb(), o = B(e).toRgb(), a = i / 100, r = 2 * a - 1, l = o.a - s.a;
        ...
        var i = B(t), n = B(e), s = i.toRgb(), o = n.toRgb(), a = i.getBrightness(), r = n.getBrightness(), l = Math.max(s.r, o.r) - Math.min(s.r, o.r) + Math.max(s.g, o.g) - Math.min(s.g, o.g) + Math.max(s.b, o.b) - Math.min(s.b, o.b);
        ...
        for (var i = null, n = 0, s = !1, o = 0; o < e.length; o++) {
            var a = B.readability(t, e[o]), r = a.brightness > 125 && a.color > 500, l = 3 * (a.brightness / 125) + a.color / 500;
    ...
    function y(t) {
        ...
        if (e = E(t.a, /(?:Linux|CrOS|CrKey) ([^;)]+)/, 1))for (var e = e.split(/\s/), i = 0; i < e.length; i += 1)if (/^[\d\._]+$/.test(e[i]))return e[i];
        return (t = E(t.a, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2)) ? t : "Unknown"
    }

    function S(t) {
        var e = b(t), i = m(y(t)), n = m(E(t.a, /AppleWeb(?:K|k)it\/([\d\.\+]+)/, 1)), s = "Unknown", o = new f, o = "Unknown", a = !1;
    ...
    function F(t, e, i, n, o) {
        if (i = i || {}, 0 === e.length && o)C(t.u); else for (t.R += e.length, o && (t.aa = o), o = 0; o < e.length; o++) {
    ...
    v.prototype.parse = function () {
        ...
        if (-1 != this.a.indexOf("MSIE") || -1 != this.a.indexOf("Trident/")) {
            t = b(this);
            var e = m(y(this)), i = null, n = E(this.a, /Trident\/([\d\w\.]+)/, 1), i = m(-1 != this.a.indexOf("MSIE") ? E(this.a, /MSIE ([\d\w\.]+)/, 1) : E(this.a, /rv:([\d\w\.]+)/, 1));
            "" != n && m(n), t = new g("MSIE", 0, 0, 0, 0, 0, 0, new p("Windows" == t && 6 <= i.c || "Windows Phone" == t && 8 <= e.c, !1))
        } else if (-1 != this.a.indexOf("Opera"))t:if (t = m(E(this.a, /Presto\/([\d\w\.]+)/, 1)), m(y(this)), null !== t.c || m(E(this.a, /rv:([^\)]+)/, 1)), -1 != this.a.indexOf("Opera Mini/"))t = m(E(this.a, /Opera Mini\/([\d\.]+)/, 1)), t = new g("OperaMini", 0, 0, 0, b(this), 0, 0, new p(!1, !1)); else {
    ...
    R.prototype.start = function () {
        ...
        var e = new k(this.d, t), i = [], n = t.timeout;
    ...
    }, {id: "fade-right", title: "Fade in from left"}, {
        id: "fade-left",
        title: "Fade in from right"
    }, {id: "fade-out", title: "Fade out"}, {id: "current-visible", title: "Fade in then out"}],
    ...
    THEME_TRANSITIONS: [{id: "slide", title: "Slide"}, {id: "linear", title: "Linear", deprecated: !0}, {
        id: "fade",
        title: "Fade"
    }, {id: "none", title: "None"}, {id: "default", title: "Convex"}, {
        id: "concave",
        title: "Concave"
    }, {id: "zoom", title: "Zoom"}, {id: "cube", title: "Cube", deprecated: !0}, {
        id: "page",
        title: "Page",
        deprecated: !0
    }],
    ...
    BLOCKS: new SL.collections.Collection([{
        ...
        label: "Text",
        icon: "type"
    }, {type: "image", factory: "Image", label: "Image", icon: "picture"}, {
        type: "shape",
        factory: "Shape",
        label: "Shape",
        icon: "shapes"
        ...
        label: "Iframe",
        icon: "browser"
    }, {type: "table", factory: "Table", label: "Table", icon: "table"}, {
        type: "code",
        factory: "Code",
        label: "Code",
        icon: "file-css"
    }, {type: "math", factory: "Math", label: "Math", icon: "divide"}, {
        type: "snippet",
        factory: "Snippet",
        label: "snippet",
        icon: "file-xml",
    ...
    ASSET_URLS: {
        ...
        "reveal-plugins/markdown/marked.js": "",
        "reveal-plugins/markdown/markdown.js": "",
        "reveal-plugins/highlight/highlight.js": ""
    }
}, SL.config.V1 = {
    ...
    TYPE: "custom-fonts", init: function (t) {
        this._super($.extend({
        ...
        window.SLGoogleFontList ? this.setupGoogleFontAutocomplete() : $.get(SL.config.GOOGLE_FONTS_LIST).done(function (t) {
            window.SLGoogleFontList = t.items.map(function (t) {
                return {family: t.family, variants: t.variants.join(", ")}
        ...
        var t = this.typekitInput.val() || "", e = this.googleInput.val() || "";
        this.options.theme ? (this.saveLoader.stop(), this.options.theme.setAll({
            ...
            type: "PUT",
            context: this,
            data: {deck: {font_typekit: t, font_google: e}}
        }).done(function () {
        ...
        var t = SL.fonts.parseGoogleFontFamilies(this.googleInput.val() || ""), e = t.length + " " + SL.util.string.pluralize("font", "s", t.length > 1) + ": ";
        e += t.map(function (t) {
    ...
    init: function (t) {
        this._super($.extend({
            ...
            }, {label: "Reload", className: "positive", callback: this.onReloadClicked.bind(this)}]
        }, t))
    },
    render: function () {
    ...
    init: function (t) {
        this._super($.extend({
            ...
            headerActions: [{
                ...
                className: "outline",
                callback: this.close.bind(this)
            }, {label: "Insert", className: "positive", callback: this.insertAndClose.bind(this)}]
    ...
    init: function (t) {
        ...
        if (!this.isInEditor()) {
            SL.helpers.PageLoader.show({message: "Loading"});
    ...
    init: function (t, e) {
        ...
        if (e = e || {}, !t.rendered) {
            ...
            var n = moment(t.get("created_at")), s = n.format("h:mm A"), o = n.format("MMM Do") + " at " + n.format("h:mm:ss A"), a = i ? i.get("first_name") : "N/A";
            a = (a || "").toLowerCase();
    ...
    }, {label: "New deck", icon: "plus", url: SL.routes.DECK_NEW(SL.current_user.get("username"))}];
    if (SL.current_user.isEnterpriseManager()) {
        ...
        }, {label: "Team settings", url: SL.routes.TEAM_EDIT(SL.current_team)}, {
            label: "Team members",
    ...
    init: function (t, e, i) {
        this.options = $.extend({editable: !0}, i), this.media = t, this.media.changed.add(this.onMediaChanged.bind(this)), this.tags = e, this.tags.changed.add(this.onTagsChanged.bind(this)), this.tags.associationChanged.add(this.onTagAssociationChanged.bind(this)), this.filterChanged = new signals.Signal, this.onSearchInput = $.throttle(this.onSearchInput, 300), this.render(), this.recount(), this.selectDefaultFilter(!0)
    }, render: function () {
        ...
        }, 1), this.scrollElement.animate({scrollTop: t.prop("offsetTop") + 80 - this.scrollElement.height()}, 300)), t.addClass("is-editing");
        ...
        var i = t.data("model"), n = t.find(".label-input"), s = t.find(".label-output");
        ...
        t && t.length && t.forEach(function (t) {
            ...
            this.stopEditingTag(e, !0), e.css({height: 0, padding: 0, opacity: 0}), setTimeout(function () {
                e.remove()
        ...
        var e = $(t.target), i = e.closest(".media-library-filter");
    ...
    init: function () {
        ...
        if (t.preventDefault(), this.currentDropTarget) {
            ...
            var e = this.ghostElement, i = this.currentDropTarget.get(0).getBoundingClientRect(), n = i.left + (i.width - this.ghostWidth) / 2 - this.ghostOffset.x, s = i.top + (i.height - this.ghostHeight) / 2 - this.ghostOffset.y, o = "translate(" + n + "px," + s + "px) scale(0.2)";
            e.css({
    ...
    init: function (t, e, i) {
        ...
        var n = $('<div class="media-library-list-item"></div>'), s = {
            model: t,
            element: n,
            elementNode: n.get(0),
            selected: !1,
        ...
        if (SL.tooltip.isVisible() && SL.tooltip.hide(), this.filteredItems.length)for (var t, e, i = this.domElement.scrollTop(), n = 100, s = this.domElement.outerHeight(), o = 0, a = this.filteredItems.length; a > o; o++)t = this.filteredItems[o], e = Math.floor(o / this.columnCount) * this.cellHeight, e + this.cellHeight - i > -n && s + n > e - i ? (t.overlay || this.attachOverlay(t), t.elementNode.hasAttribute("data-thumb-loaded") || (t.elementNode.style.backgroundImage = 'url("' + t.model.get("thumb_url") + '")', t.elementNode.setAttribute("data-thumb-loaded", "true"))) : t.overlay && !t.selected && this.detachOverlay(t)
        ...
        return t.overlay || !this.options.editable ? !1 : (0 === this.overlayPool.length && this.overlayPool.push($(['<div class="info-overlay">', '<span class="info-overlay-action inline-button icon i-embed" data-tooltip="Insert SVG inline"></span>', '<span class="info-overlay-action label-button icon edit-text" data-tooltip="Rename"></span>', '<span class="info-overlay-action select-button" data-tooltip="Select">', '<span class="icon i-checkmark checkmark"></span>', "</span>", "</div>"].join(""))), t.overlay = this.overlayPool.pop(), t.overlay.appendTo(t.element), void this.refreshOverlay(t))
        ...
        if (this.lastSelectedItem) {
            var e = !t.selected, i = this.lastSelectedItem.element.index(), n = t.element.index();
            if (n > i)for (var s = i + 1; n >= s; s++)this.toggleSelection(this.items[s], e); else if (i > n)for (var s = n; i > s; s++)this.toggleSelection(this.items[s], e)
        }
        ...
        this.selectedItems.size() > 1 && (t = "Do you want to permanently delete these items from all existing presentations or remove them from the library?"), SL.prompt({
            ...
            data: [{html: "<h3>Cancel</h3>"}, {
                ...
                html: "<h3>Delete permanently</h3>", selected: !0, className: "negative", callback: function () {
                    this.selectedItems.forEach(function (t) {
        ...
        var e = SL.util.trig.distanceBetween({x: this.mouseDownX, y: this.mouseDownY}, {
            x: t.clientX,
            y: t.clientY
        });
        ...
        var e = $(t.target), i = e.closest(".media-library-list-item").data("item");
    ...
    init: function (t, e, i) {
        ...
        this.filters = new SL.components.medialibrary.Filters(this.media, this.tags, {editable: this.isEditable()}), this.filters.filterChanged.add(this.onFilterChanged.bind(this)), this.filters.appendTo(this.sidebarElement)
        ...
        this.list = new SL.components.medialibrary.List(this.media, this.tags, {editable: this.isEditable()}), this.list.itemSelected.add(this.select.bind(this)), this.list.appendTo(this.contentElement)
        ...
        this.dragAndDropInstructions = $(['<div class="media-library-drag-instructions">', '<div class="inner">', "Drop to upload media", "</div>", "</div>"].join("")), this.dragAndDropListener = {
            onDragOver: function () {
                ...
                if (this.isSelecting())this.uploader.enqueue(e[0]); else for (var i = 0; i < e.length; i++)this.uploader.enqueue(e[i]);
    ...
    open: function (t) {
        t = $.extend({select: null}, t), this._super(t), this.currentPage.configure(t), this.currentPage.bind(), this.refresh(), this.layout()
    },
    close: function () {
    ...
    init: function (t) {
        this.media = t, this.options = {multiple: !0}, this.queue = new SL.collections.Collection, this.render(), this.renderInput(), this.bind()
    },
    bind: function () {
    ...
    enqueue: function (t) {
        ...
        e.uploaderElement = $(['<div class="media-library-uploader-item">', '<div class="item-text">', '<span class="status"><span class="icon i-clock"></span></span>', '<span class="filename">' + (t.name || "untitled") + "</span>", "</div>", '<div class="item-progress">', '<span class="bar"></span>', "</div>", "</div>"].join("")), e.uploaderElement.appendTo(this.uploadList), setTimeout(e.uploaderElement.addClass.bind(e.uploaderElement, "animate-in"), 1), e.uploadCompleted.add(this.onUploadCompleted), e.uploadFailed.add(this.onUploadFailed), e.uploadProgressed.add(function (t) {
            var i = "scaleX(" + t + ")";
            e.uploaderElement.find(".bar").css({"-webkit-transform": i, "-moz-transform": i, transform: i})
    ...
    init: function (t) {
        ...
        if (this.config.anchor.length) {
            ...
            this.domElement.css({
                left: Math.round(o),
                top: Math.round(a)
            }), this.arrowElement.css({left: Math.round(u), top: Math.round(p)}), this.hitareaElement.css({
                top: -e,
                right: -e,
                bottom: -e,
                left: -e
        ...
        this.isMouseOver || ("function" != typeof this.config.showOnHoverCondition || this.config.showOnHoverCondition()) && ($(document).on("mousemove", this.onDocumentMouseMove), this.hideTimeout = -1, this.isMouseOver = !0, this.show())
    }, onDocumentMouseMove: function (t) {
    ...
    init: function (t) {
        ...
        var t = $('<div class="section selector font"><h3 class="section-heading">Typography</h3><ul></ul></div>').appendTo(this.domElement), e = t.find("ul");
        if (this.config.supportsCustomFonts) {
            var i = "You can use custom fonts from Typekit, Google or your own host. Click to learn more.", n = "http://help.slides.com/knowledgebase/articles/1077976";
    ...
    function i(t, e) {
        if (!SL.util.device.IS_PHONE && !SL.util.device.IS_TABLET) {
            ...
            }), d.align && a.css("text-align", d.align), n(), a.stop(!0, !0).animate({opacity: 1}, {duration: 150}), $(window).on("resize scroll", n), $(d.anchor).parents(".sl-scrollable").on("scroll", n)
        }
    }
    ...
    function n() {
        ...
        if (t.length) {
            ...
            var c = t.outerWidth(), p = t.outerHeight(), f = r.outerWidth(), m = r.outerHeight(), g = o.x - $(window).scrollLeft(), v = o.y - $(window).scrollTop(), b = f / 2, y = m / 2;
            ...
            l.css({left: Math.round(b), top: Math.round(y)}), a.css({
                left: Math.round(g),
                top: Math.round(v)
