...
(function (global, factory) {
    ...
    /**
     * Convert a attributes object to a string
     * @param   { Object } attributes - attributes object we need to parse
     * @returns { String } resulting css string
     */
    function attributesObjectToString(attributes) {
        return Object.keys(attributes).reduce(function (acc, prop) {
    ...
    function setAttr(dom, name, val) {
        ...
        else
        {
            if ("attributes" == name) {
                attrLists = val.split(";");
                for (var elt in attrLists) {
                    if ("" != attrLists[elt]) {
                        attrElt = attrLists[elt].split(":");
                        dom.setAttribute(attrElt[0].trim(), attrElt[1].trim());
                    }
                }
            } else {
    ...
    var dom = Object.freeze({
        ...
        attributesObjectToString: attributesObjectToString,
        getAttr: getAttr,
        setAttr: setAttr,
...
// skip the following code on the server
    ...
    function updateExpression(expr) {
        ...
        var dom = expr.dom,
            ...
            isAttributes = attrName === 'attributes',
            hasValue,
            isObj,
            value;
        ...
        // convert the style/class/attributes objects to strings
        if (isObj) {
            ...
            if (isClassAttr) {
                ...
                value = attributesObjectToString(value);
            }
        }
        ...
        if (isObj && !isToggle && !isAttributes) { return }
