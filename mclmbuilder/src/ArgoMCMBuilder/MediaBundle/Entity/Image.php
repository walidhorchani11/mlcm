 ...
 * Image.
 *
 * @ORM\Table(name="mcm_image")
 * @ORM\Entity(repositoryClass="ArgoMCMBuilder\MediaBundle\Repository\ImageRepository")
 */
class Image
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ArgoMCMBuilder\PresentationBundle\Entity\Revision", mappedBy="image")
     * @ORM\JoinColumn(name="revision_id", referencedColumnName="id" , onDelete="CASCADE" )
     */
    protected $revisionImage;
    ...
    {
        $this->revisionImage = new ArrayCollection();
        $this->shared = 0;
        $this->master = 0;
        $this->legend = '';
    }
     ...
     *
     * @param Revision $revisionImage
     *
     * @return Image
     */
    public function addRevisionImage(Revision $revisionImage)
    {
        $this->revisionImage[] = $revisionImage;

        return $this;
    }

    /**
     * Remove presentationImage.
     *
     * @param Revision $revisionImage
     */
    public function removeRevisionImage(Revision $revisionImage)
    {
        $this->revisionImage->removeElement($revisionImage);
    }
     ...
     * @return mixed
     */
    public function getRevisionImage()
    {
        return $this->revisionImage;
    }

    /**
     * @param mixed $revisionImage
     */
    public function setRevisionImage($revisionImage)
    {
        $this->revisionImage = $revisionImage;
    }
