...
namespace ArgoMCMBuilder\PresentationBundle\Parser;
...
class simple_html_dom_node
{
    ...
    public $nodes = array();
    public $parent = null;
    // The "info" array - see self::HDOM_INFO_... for what each element contains.
    public $_ = array();
    public $tag_start = 0;
    private $dom = null;
    ...
    public function outertext()
    {
        ...
        // render inner text
        if (isset($this->_[self::HDOM_INFO_INNER])) {
            // If it's a br tag...  don't return the self::HDOM_INNER_INFO that we may or may not have added.
            if ($this->tag != 'br') {
