    ...
    listpopin: function() {
        ...
        _.each($('.slidespop section'), function(value, key) {
            ...
            if (process.env.ISPROD) {
                imageUrl = `https://s3-${process.env.REGION}.amazonaws.com/${process.env.ENV_BUCKET}/${TWIG.companyParentName.replace(/\s/g, '-')}/thumbs/${popinThumb}`;
            }
