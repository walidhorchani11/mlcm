    ...
    function(t, e) {
        ...
        function d(t, e, i, n) {
            if (se.acceptData(t)) {
                var s, o, a = se.expando,
                    ...
                    l = r ? se.cache : t,
                    c = r ? t[a] : t[a] && a;
                if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e) return c || (c = r ? t[a] = G.pop() || se.guid++ : a), l[c] || (l[c] = r ? {} : {
                    toJSON: se.noop
        ...
        function L(t, e) {
            ...
            if (1 === e.nodeType) {
                ...
                "script" === i && e.text !== t.text ? (S(e).text = t.text, y(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML), ie.html5Clone && t.innerHTML && !se.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && De.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === i ? e.defaultSelected = e.selected = t.defaultSelected : ("input" === i || "textarea" === i) && (e.defaultValue = t.defaultValue)
            }
        }
        ...
        function N(t, e, i) {
            for (var n, s = (Si[e] || []).concat(Si["*"]), o = 0, a = s.length; a > o; o++)
        ...
        var ce = function(t) {
                ...
                if (O && !n) {
                    ...
                    if (E.qsa && (!N || !N.test(t))) {
                        if (p = h = B, f = e, m = 9 === r && t, 1 === r && "object" !== e.nodeName.toLowerCase()) {
                            for (c = w(t), (h = e.getAttribute("id")) ? p = h.replace(ye, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + u(c[l]);
            ...
            function v(t, e, i, s, o, a) {
                return s && !s[B] && (s = v(s)), o && !o[B] && (o = v(o, a)), n(function(n, a, r, l) {
                    var c, d, h, u = [],
                        ...
                        S = i ? o || (n ? t : f || s) ? [] : a : b;
                    if (i && i(b, S, r, l), s)
                        for (c = g(S, p), s(c, [], r, l), d = c.length; d--;)(h = c[d]) && (S[p[d]] = !(b[p[d]] = h));
                    if (n) {
                        if (o || t) {
                            if (o) {
                ...
                var s = i.length > 0,
                    ...
                    a = function(n, a, r, l, c) {
                        var d, h, u, p = 0,
                            ...
                            E = S.length;
                        for (c && (A = a !== M && a); f !== E && null != (d = S[f]); f++) {
                            if (o && d) {
                                for (h = 0; u = t[h++];)
                                    if (u(d, a, r)) {
                                        l.push(d);
            ...
            var y, E, T, L, _, w, k, C, A, x, D, I, M, R, O, N, P, $, U, B = "sizzle" + -new Date,
                F = t.document,
                j = 0,
                H = 0,
                z = i(),
            ...
            E = e.support = {}, _ = e.isXML = function(t) {
                ...
                return i !== M && 9 === i.nodeType && i.documentElement ? (M = i, R = i.documentElement, O = !_(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !E.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === F && U(F, t) ? -1 : e === i || e.ownerDocument === F && U(F, e) ? 1 : x ? ee.call(x, t) - ee.call(x, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return D = !0, 0;
                    var n, s = 0,
                        o = t.parentNode,
                ...
                var i = T.attrHandle[e.toLowerCase()],
                    n = i && J.call(T.attrHandle, e.toLowerCase()) ? i(t, e, !O) : void 0;
                ...
                var e, i = [],
                    n = 0,
                    s = 0;
                if (D = !E.detectDuplicates, x = !E.sortStable && t.slice(0), t.sort(X), D) {
                        ...
                        return 1 === n && 0 === s ? function(t) {
                            ...
                            if (g) {
                                ...
                                if (f = [a ? g.firstChild : g.lastChild], a && b) {
                                    for (d = g[B] || (g[B] = {}), c = d[t] || [], p = c[0] === j && c[1], u = c[0] === j && c[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (u = p = 0) || f.pop();)
                                        if (1 === h.nodeType && ++u && h === e) {
                                            d[t] = [j, p, u];
                                            break
                                        }
                                } else if (b && (c = (e[B] || (e[B] = {}))[t]) && c[0] === j) u = c[1];
                                else
                                    for (;
                                        (h = ++p && h && h[m] || (u = p = 0) || f.pop()) && ((r ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++u || (b && ((h[B] || (h[B] = {}))[t] = [j, u]), h !== e)););
            ...
            return h.prototype = T.filters = T.pseudos, T.setFilters = new h, w = e.tokenize = function(t, i) {
                ...
                if (i = i || [], 1 === h.length) {
                    ...
                    for (s = fe.needsContext.test(t) ? 0 : o.length; s-- && (a = o[s], !T.relative[r = a.type]);)
                        if ((l = T.find[r]) && (n = l(a.matches[0].replace(Ee, Te), Se.test(o[0].type) && d(e.parentNode) || e))) {
                            if (o.splice(s, 1), t = n.length && u(o), !t) return Z.apply(i, n), i;
                            break
                        }
                }
                return (c || k(t, h))(n, e, !O, i, Se.test(t) && d(e.parentNode) || e), i
            }, E.sortStable = B.split("").sort(X).join("") === B, E.detectDuplicates = !!D, I(), E.sortDetached = s(function(t) {
        ...
        Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, se.extend({
            clone: function(t, e, i) {
                ...
                if (ie.html5Clone || se.isXMLDoc(t) || !Ue.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (qe.innerHTML = t.outerHTML, qe.removeChild(o = qe.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || se.isXMLDoc(t)))
                ...
                for (var s, o, a, r, l, c, d, h = t.length, u = m(e), p = [], f = 0; h > f; f++)
                    if (o = t[f], o || 0 === o)
                        if ("object" === se.type(o)) se.merge(p, o.nodeType ? [o] : o);
                            ...
                            if (!ie.leadingWhitespace && Be.test(o) && p.push(e.createTextNode(Be.exec(o)[0])), !ie.tbody)
            ...
            domManip: function(t, e) {
                ...
                var i, n, s, o, a, r, l = 0,
                    ...
                    u = t[0],
                    p = se.isFunction(u);
                if (p || c > 1 && "string" == typeof u && !ie.checkClone && Ye.test(u)) return this.each(function(i) {
                    var n = d.eq(i);
                ...
                if (c && (r = se.buildFragment(t, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                    ...
                    if (s)
                        for (a = o[o.length - 1].ownerDocument, se.map(o, y), l = 0; s > l; l++) n = o[l], Xe.test(n.type || "") && !se._data(n, "globalEval") && se.contains(a, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Ge, "")));
                    r = i = null
                }
                return this
            }
        ...
        se.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(se.isFunction(t) ? function(i) {
                    ...
                    if ("string" === i)
                        for (var e, n = 0, s = se(this), o = t.match(Se) || []; e = o[n++];) s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
        ...
        Ri = ji.exec(Oi.toLowerCase()) || [], se.extend({
            ...
            ajax: function(t, e) {
                function i(t, e, i, n) {
                    var s, d, v, b, y, T = e;
                    2 !== S && (S = 2, r && clearTimeout(r), c = void 0, a = n || "", E.readyState = t > 0 ? 4 : 0, s = t >= 200 && 300 > t || 304 === t, i && (b = H(h, E, i)), b = z(h, b, E, s), s ? (h.ifModified && (y = E.getResponseHeader("Last-Modified"), y && (se.lastModified[o] = y), y = E.getResponseHeader("etag"), y && (se.etag[o] = y)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, d = b.data, v = b.error, s = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), E.status = t, E.statusText = (e || T) + "", s ? f.resolveWith(u, [d, T, E]) : f.rejectWith(u, [E, T, v]), E.statusCode(g), g = void 0, l && p.trigger(s ? "ajaxSuccess" : "ajaxError", [E, h, s ? d : v]), m.fireWith(u, [E, T]), l && (p.trigger("ajaxComplete", [E, h]), --se.active || se.event.trigger("ajaxStop")))
                }
                ...
                var n, s, o, a, r, l, c, d, h = se.ajaxSetup({}, e),
                    ...
                    E = {
                        ...
                        getResponseHeader: function(t) {
                            ...
                            if (2 === S) {
                                if (!d)
                                    for (d = {}; e = $i.exec(a);) d[e[1].toLowerCase()] = e[2];
                                e = d[t.toLowerCase()]
                            }
                ...
                if (f.promise(E).complete = m.add, E.success = E.done, E.error = E.fail, h.url = ((t || h.url || Oi) + "").replace(Ni, "").replace(Fi, Ri[1] + "//"), h.type = e.method || e.type || h.method || h.type, h.dataTypes = se.trim(h.dataType || "*").toLowerCase().match(Se) || [""], null == h.crossDomain && (n = ji.exec(h.url.toLowerCase()), h.crossDomain = !(!n || n[1] === Ri[1] && n[2] === Ri[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Ri[3] || ("http:" === Ri[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = se.param(h.data, h.traditional)), F(Hi, h, e, E), 2 === S) return E;
        ...
        se.offset = {
            ...
            offset: function(t) {
                ...
                var e, i, n = {
                    ...
                    s = this[0],
                    o = s && s.ownerDocument;
                if (o) return e = o.documentElement, se.contains(e, s) ? (typeof s.getBoundingClientRect !== Le && (n = s.getBoundingClientRect()), i = W(o), {
...
SL.current_user = new SL.models.User(SLConfig.current_user), "object" == typeof SLConfig.deck && (SL.current_deck = new SL.models.Deck(SLConfig.deck)), "object" == typeof SLConfig.team && (SL.current_team = new SL.models.Team(SLConfig.team)))
    }
...
SL("models").Media = SL.models.Model.extend({
    ...
    isImage: function() {
        return true ; /*/^image\//.test(this.get("content_type"))*/
    },
    isSVG: function() {
...
SL("data").tokens = {
    ...
    AJAX_GET_DECK: function(t) {
     //   return "http://m.mejri.clm-builder.dev/app_dev.php/en/decks"
        return "http://" + window.location.host + "/app_dev.php/api/v1/revisions/" + TWIG.idPres +"/" + t +".json"
    },
    AJAX_CREATE_DECK: function() {
        return "http://" + window.location.host + "/app_dev.php/api/v1/revisions/new.json"
    },
    AJAX_UPDATE_DECK: function(t) {
        //return "http://" + window.location.host + "/app_dev.php/api/v1/revisions/" + SL.current_deck.get("pres") +"/" + SL.current_deck.get("id") +".json"
        return "http://" + window.location.host + "/app_dev.php/api/v1/revisions/" + TWIG.idPres +"/" + SL.current_deck.get("id") + ".json"
	//return Routing.generate('argomcmbuilder_presentation_v1_presentation_updaterevision', {'idPres': TWIG.idPres, 'idRev': SL.current_deck.get("id")}, true);
    },
    ...
    AJAX_SLIDE_TEMPLATES_LIST: "http://" + window.location.host + "/app_dev.php/en/slidetemplate",
    AJAX_SLIDE_TEMPLATES_CREATE: "http://" + window.location.host + "/app_dev.php/en/slidetemplate",
    ...
    AJAX_CHECK_STATUS: "http://" + window.location.host + "/app_dev.php/en/status",
    AJAX_MEDIA_LIST: "http://" + window.location.host + "/app_dev.php/api/v1/medias/.json",
    AJAX_MEDIA_CREATE: "http://" + window.location.host + "/app_dev.php/api/v1/medias/new.json",
    AJAX_MEDIA_UPDATE: function(t) {
        return "/app_dev.php/api/v1/media/" + t + ".json"
    },
    AJAX_MEDIA_DELETE: function(t) {
        return "http://" + window.location.host + "/app_dev.php/api/v1/media/" + TWIG.idPres +"/" + t + ".json"
    },
    AJAX_MEDIA_TAG_LIST: "http://" + window.location.host + "/app_dev.php/api/v1/tags/.json",
    ...
    DECK_DELETE_SLIDE_CONFIRM: "Are you sure you want to delete this screen? (In case you want to delete a screen of the first level, all the screens created underneath will be deleted as well.)",
...
SL("components").ThemeOptions = Class.extend({
    ...
    render: function() {
        this.domElement = $('').appendTo(this.config.container), "string" == typeof this.config.className && this.domElement.addClass(this.config.className), this.config.themes && this.renderThemes(), (this.config.center || this.config.rollingLinks) && this.renderOptions()/*, this.config.colors && this.renderColors()*/, this.config.fonts && this.renderFonts()/*, this.config.transitions && this.renderTransitions(), this.config.backgroundTransitions && this.renderBackgroundTransitions()*/
    },
    ...
    renderFonts: function() {
        var t = $('<div class="section selector font"><label>Fonts</label><select class="form-control m-b sl-select" name="menu-font" id="menu-font"></select></div>').appendTo(".style .sl-themeoptions .font-list"),
            e = t.find("select");
        this.config.fonts.forEach(function(t) {
            var i = $('<option data-font="' + t.id + '" data-name="' + t.title + '">' + t.title + '</option>');
...
SL.views.decks.Speaker.LAYOUT_DEFAULT = "default", SL.views.decks.Speaker.LAYOUT_WIDE = "wide", SL.views.decks.Speaker.LAYOUT_TALL = "tall", SL.views.decks.Speaker.LAYOUT_NOTES_ONLY = "notes-only", SL("views.devise").All = SL.views.Base.extend({
    init: function() {
